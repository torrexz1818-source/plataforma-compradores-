...
agentSection({
  ...
  logic: [
    ...
    'El servicio extrae contexto de archivos temporales y arma el prompt final.',
    'OpenAI devuelve JSON con documento, bases de licitacion, correo a proveedores, checklist y recomendaciones.',
  ...
  diagramLines: [
    ...
    '          |',
    '          v',
    '[Extraccion temporal de archivos]',
    '          |',
    '          v',
    '[Prompt GENERATE + OpenAI JSON]',
    '          |',
    '          v',
...
agentSection({
  ...
  logic: [
    ...
    'Cada archivo se guarda temporalmente y se extrae texto.',
    'El agente arma un prompt con servicio, objetivo y textos extraidos.',
    'OpenAI genera JSON con matriz ponderada, criterios automaticos, ranking, riesgos y recomendacion.',
  ...
  diagramLines: [
    ...
    '          |',
    '          v',
    '[Extraccion PDF/DOCX/XLSX/CSV/Imagen]',
    '          |',
    '          v',
    '[Prompt comparativo + OpenAI JSON]',
    '          |',
    '          v',
...
agentSection({
  ...
  logic: [
    ...
    'Extrae texto de documentos y compacta solo lineas relevantes para TCO.',
    'Si hay imagenes, las manda como contenido multimodal a OpenAI.',
    'OpenAI realiza analisis LLM-first, sin inventar datos faltantes.',
    'El servicio sanea resultados: evita ceros falsos, normaliza niveles de riesgo y completa defaults.',
    'Si OpenAI falla, genera un fallback preliminar con datos detectados.',
  ],
  diagramLines: [
...
agentSection({
  ...
  logic: [
    ...
    'Python perfila archivos: columnas numericas, fechas, categorias, calidad de datos y muestras.',
    'Python calcula KPIs, tablas, graficos base e insights basicos.',
    'Si se requiere LLM o hay documentos poco estructurados, se envia un resumen compacto a OpenAI.',
    'OpenAI complementa resumen ejecutivo, KPIs documentales, graficos, tablas, observaciones y recomendaciones.',
    'El servicio fusiona resultados Python + LLM, normaliza charts y limita contenido para UI.',
    'Si OpenAI falla, el dashboard sigue funcionando con calculos Python.',
  ],
  diagramLines: [
    '[Usuario sube datos + objetivo]',
    '          |',
    '          v',
    '[Python profile_files]',
    '          |',
    '          v',

...
const SupplierLayout = () => {
  ...
  const navSections = isAdmin
    ...
    : [{ title: '', items: supplierItemsForRole }];
  ...
  const activeLinkClass = isAdmin ? 'sidebar-link-active' : 'supplier-sidebar-link-active';
      ...
      <div key={section.title} className="space-y-0.5">
        <button
          ...
          className={cn(
            ...
            hasActiveItem ? activeLinkClass : 'sidebar-link',
          )}
        >

...
SECTION_LABELS = {
    ...
    "dataProfile": "Perfil y calidad de datos",
    "metadata": "Metadata del reporte",
    "executiveSummary": "Resumen ejecutivo estructurado",
    "dashboardPlan": "Plan validado del dashboard",
